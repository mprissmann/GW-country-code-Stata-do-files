// assign Gledditsch and Ward country codes to country names
quietly {
...
replace	ccode =	260		if inlist(country	,"Deu"	,"Germany"					,"German Federal Republic"		)	
...
replace	ccode =	484		if inlist(country	,"Cog"	,"Congo"	,"Republicofcongo"	,"Congorep"	,"Congorepublicof"		,"Congo, Rep."	,"Congo Rep."	)	
replace	ccode =	490		if inlist(country	,"Cod"	,"Congothedemocraticrepublicofthe"	,"Drofthecongo"	,"Democraticrepublicofthecongo"	,"Congodemrep"	,"Congodemocraticrepublicof"	,"Congo, DR - Zaire"		)	
...
replace	ccode =	731		if inlist(country	,"Prk"	,"Koreademocraticpeoplesrepublicof"	,"Northkorea"	,"Koreadempeoplesrep"	,"Koreademocraticrepublicof"		,"Korea, Dem. People's Rep."	,"Korea, Democratic Republic Of"	)	
replace	ccode =	732		if inlist(country	,"Kor"	,"Korearepublicof"	,"Republicofkorea"	,"Southkorea"	,"Korearep"	,"Korea"	,"Korea, Rep."	,"Republic Of Korea"	)	
...
replace	ccode =	775		if inlist(country	,"Mmr"	,"Myanmar"					,"Myanmar"		)	
...
capture noisily groups country if ccode==.
